...
promptForm.addEventListener("click", (event) => {
 ...
 //  console.log("a")
  ...
  //  if (promptWindow.promptList.length >= MAX_PROMPTS){
        ...
        map.classList.add("tw-scale-100")
        map.classList.remove("tw-scale-0")
...
const typed = new Typed('#prompts-sample', {
    strings: ["Going Somewhere to Eat Now?", 
                "Trying your luck to find an Empty Carpark?", 
                "CarPark Locator shows you the nearest Lots", 
                "Click on Get Started to Find Out"],
    typeSpeed: 80,
    smartBackspace: true, 
    loop: true,
    backDelay: 2000,
...
sections.forEach((sec) => {
    ...
    const revealTargets = sec.querySelectorAll(".reveal-up");
